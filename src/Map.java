...
public class Map
{
    ...
    public void addEdge(final Country c1, final Country c2) {
        if (this.getCountryKey(c1) != -1 && this.getCountryKey(c2) != -1) {
            this.adjacency[this.getCountryKey(c1)].addFirst(this.getCountryKey(c2));
            this.adjacency[this.getCountryKey(c2)].addFirst(this.getCountryKey(c1));
        }
        else {
    ...
    public void colorTheCountry(final Country country, final Color color) {
        Arrays.fill(this.colorAvailable, true);
